...
@Data
@Entity
@Table(name = "vms_m_visitor_govt_type")
public class VMS_M_Visitor_Govt_Type implements Comparable<VMS_M_Visitor_Govt_Type> {

	@Override
	public int compareTo(VMS_M_Visitor_Govt_Type visitorType) {
