...
@Data
@Entity
@Table(name = "vms_m_visitor_type_history")
public class VMS_M_Visitor_Type_History implements Comparable<VMS_M_Visitor_Type_History> {

	@Override
	public int compareTo(VMS_M_Visitor_Type_History visitorTypeHistory) {
    ...
    private VMS_M_Visitor_Type parentVisitorType;
