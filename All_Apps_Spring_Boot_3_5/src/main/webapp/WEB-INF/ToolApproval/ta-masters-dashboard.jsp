            ...
            <div class="row">
              <div class="col-sm-6 col-lg-4 col-md-3">
                <div class="card card-widget widget-user-2 shadow">
                  <div class="widget-user-header bg-1" title="Business Unit Master" onclick="location.href='ta-business-unit';" style="cursor: pointer;">
                    <h4 class="font-weight-bold"><i class="fas fa-sitemap"></i>&emsp;Business Unit Master</h4>
                  </div>
                  <div class="card-footer p-0">
                    <ul class="nav flex-column">
                      <li class="nav-item nav-link font-weight-bold font-1">Total Business Units
                        <span class="float-right">${buTotal}</span>
                      </li>
              ...
              <div class="col-sm-6 col-lg-4 col-md-3">
                <div class="card card-widget widget-user-2 shadow">
                  <div class="widget-user-header bg-2" title="Recovery Type Master" onclick="location.href='ta-recovery-type';" style="cursor: pointer;">
                    <h4 class="font-weight-bold"><i class="fas fa-exchange-alt"></i>&emsp;Recovery Type Master</h4>
                  </div>
                  <div class="card-footer p-0">
                    <ul class="nav flex-column">
                      <li class="nav-item nav-link font-weight-bold font-1">Total Recovery Types
                        <span class="float-right">${rtTotal}</span>
                      </li>
                      <li class="nav-item nav-link sequence-font-5 font-weight-bold">Active
              ...
              <div class="col-sm-6 col-lg-4 col-md-3">
                <div class="card card-widget widget-user-2 shadow">
                  <div class="widget-user-header bg-3" title="Status Master" onclick="location.href='ta-status';" style="cursor: pointer;">
                    <h4 class="font-weight-bold"><i class="fas fa-check-circle"></i>&emsp;Status Master</h4>
                  </div>
                  <div class="card-footer p-0">
                    <ul class="nav flex-column">
                      <li class="nav-item nav-link font-weight-bold font-1">Total Statuses
                        <span class="float-right">${statusTotal}</span>
                      </li>
                      <li class="nav-item nav-link sequence-font-5 font-weight-bold">Active
              ...
              <div class="col-sm-6 col-lg-4 col-md-3">
                <div class="card card-widget widget-user-2 shadow">
                  ...
                  <div class="card-footer p-0">
                    <ul class="nav flex-column">
                      <li class="nav-item nav-link font-weight-bold font-1">Total Approval Matrix
                        <span class="float-right">${matrixTotal}</span>
                      </li>
                      <li class="nav-item nav-link sequence-font-5 font-weight-bold">Active
