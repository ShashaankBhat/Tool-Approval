...
<html lang="en">
  <head>
    <title>RECOVERY TYPE<%@include file="../includeJSP/company_name_title.jsp"%></title>
  ...
  <body class="sidebar-mini layout-navbar-fixed sidebar-collapse pace-primary">
      ...
      <div class="content-wrapper">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item font-3 active">Recovery Type</li>
                </ol>
              </div>
            </div>
          </div>
		...
		<section class="content content-margin">
		  <div class="container-fluid">
		    ...
		    <div class="row">
		      <div class="col-md-12">
		        <form modelAttribute="taRecoveryType" action="ta-recovery-type" id="taRecoveryType" method="post">
		            ...
		            <div class="row">
		              <div class="col-md-4">
		                <div class="form-group">
		                  ...
		                  <input type="text" class="form-control" id="taRecoveryTypeName" placeholder="Enter Recovery Type Name" name="taRecoveryTypeName" />
		              ...
		              <div class="col-md-4">
		                <div class="form-check" id="isActiveDiv">
		                  ...
		                  <div class="custom-control custom-radio">
		                    <input type="radio" name="taRecoveryTypeActive" class="custom-control-input" value="1" id="taRecoveryTypeActive1" name="taRecoveryTypeActive" />
		                    <label for="taRecoveryTypeActive1" class="custom-control-label sequence-font-5">Active</label>
		                  </div>
		                  <div class="custom-control custom-radio">
		                    <input type="radio" name="taRecoveryTypeActive" class="custom-control-input" value="0" id="taRecoveryTypeActive2" name="taRecoveryTypeActive" />
		              ...
		              <div class="col-md-6">
		                <div class="form-group">
		                  ...
		                  <input type="text" class="form-control" id="taRecoveryTypeDescription" placeholder="Enter Recovery Type Description" name="taRecoveryTypeDescription" />
		          ...
		          <div class="card-body">
		            <div class="row">
		              <div class="col-md-12 tableOverFlowDiv">
		                <table class="table table-bordered table-striped dataTable" id="taRecoveryTypeTable">
		                  <thead>
    ...
    <script src="usedStaticFiles/essentials/js/jsp_js_files/toolApproval/taRecoveryTypeMaster.js"></script>
  </body>
</html>
