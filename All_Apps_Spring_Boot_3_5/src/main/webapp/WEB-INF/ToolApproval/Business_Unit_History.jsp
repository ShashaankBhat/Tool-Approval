...
<html lang="en">
  <head>
    <title>BUSINESS UNIT HISTORY<%@include file="../includeJSP/company_name_title.jsp"%></title>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-12 tableOverFlowDiv">
                        <table class="table table-bordered table-striped dataTable" id="taBusinessUnitHistoryTable">
                          <thead>
