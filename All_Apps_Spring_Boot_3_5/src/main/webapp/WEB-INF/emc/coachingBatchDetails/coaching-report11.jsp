...
<html lang="en">
  <head>
    <c:choose>
      <c:when test="${itAdmin eq 1 || emcProcessOwner eq 1 || emcAdmin eq 1 || emcMentor eq 1 }">
        <title>EXECUTIVE MENTORING REPORT | EMC<%@include file="../../includeJSP/company_name_title.jsp" %>
      </c:when>
      <c:otherwise>
        <title>EXECUTIVE COACHING REPORT | EMC<%@include file="../../includeJSP/company_name_title.jsp" %>
      </c:otherwise>
    </c:choose>
