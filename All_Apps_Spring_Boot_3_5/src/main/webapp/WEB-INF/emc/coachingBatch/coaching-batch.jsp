...
<html lang="en">
  <head>
    <title>MENTORING BATCH | EMC<%@include file="../../includeJSP/company_name_title.jsp" %></title>
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><strong>Mentoring Batch</strong></li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <c:if test="${itAdmin eq 1 || emcAdmin eq 1 }">
                <div class="row">
                  <div class="col-12" style="display: none;">
                    ...
                    <c:forEach items="${coachList }" var="coach" varStatus="coachIndex">
                      <c:choose>
                        <c:when test="${not empty coachListString }">
                          <c:set var="coachListString" value="${coachListString }||${coach.mUserId }!!${coach.userFirstName } ${coach.userLastName }" /></c:when>
                    ...
                    <c:forEach items="${programCategoryList}" var="pc">
                      <c:choose>
                        <c:when test="${pc.actCoacheeProgram == 1}">
                          <c:if test="${not fn:contains(programCategoryListString, '1!!')}">
                            <c:set var="programCategoryListString" value="${programCategoryListString}||1!!Senior Executive Coaching" />
                          </c:if>
                        </c:when>
                        <c:when test="${pc.actCoacheeProgram == 2}">
                          <c:if test="${not fn:contains(programCategoryListString, '2!!')}">
                            <c:set var="programCategoryListString" value="${programCategoryListString}||2!!Top Executive Mentoring" />
                          </c:if>
                        </c:when>
                      </c:choose>
                    </c:forEach>
                    ...
                    <c:choose>
                      <c:when test="${fn:startsWith(programCategoryListString, '||')}">
                        <c:set var="programCategoryListString" value="${fn:substring(programCategoryListString, 2, fn:length(programCategoryListString))}" />
                      </c:when>
                    </c:choose>
                ...
                <div class="col-md-12">
                  <form:form modelAttribute="actCoachingBatch" action="emc-coaching-batch" id="actCoachingBatch" method="post" onsubmit="return prepareFeedbackQuestionsForSubmit()">
                    <form:input path="questionTexts" type="hidden" id="questionsField" name="questionTexts" />
                    <form:input path="feedbackText" type="hidden" id="feedbackTextField" name="feedbackText" />
                    <form:input path="feedbackcoacheeText" type="hidden" id="feedbackCoacheeTextField" name="feedbackcoacheeText" />
                    <form:input path="feedbackMentorText" type="hidden" id="feedbackMentorTextField" name="feedbackMentorText" />
                    <form:input path="feedbackMenteeText" type="hidden" id="feedbackMenteeTextField" name="feedbackMenteeText" />
                    <div class="card card-outline collapsed-card">
                      <div class="card-header bg-1" data-card-widget="collapse">
                        <h5 class="card-title font-weight-bold">Add EMC Batch</h5>
                      ...
                      <div class="card-body" style="display: none;">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="daysBetweenTwoSession"><span class="mandatory">*</span>Avg days between two sessions(SEC)</label>
                              <form:input type="text" class="form-control" id="daysBetweenTwoSession" placeholder="Enter Avg Days" path="daysBetweenTwoSession" />
                              <span class="error invalid-feedback" id="daysBetweenTwoSessionError"></span>
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="daysBetweenTwoSessionTopExe"><span class="mandatory">*</span>Avg days between two sessions(TEM)</label>
                              <form:input type="text" class="form-control" id="daysBetweenTwoSessionTopExe" placeholder="Enter Avg Days" path="daysBetweenTwoSessionTopExe" />
                              <span class="error invalid-feedback" id="daysBetweenTwoSessionError"></span>
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <form:input type="text" disabled="true" class="form-control" id="batchDuration" placeholder="Batch Duration" path="batchDuration" />
                          ...
                          <div class="col-12">
                            <div class="card card-secondary">
                              <div class="card-header bg-3">
                                <h5 class="card-title font-weight-bold">Add Stakeholders</h5>
                              </div>
                              <div class="card-body">
                                <div class="row">
                                        ...
                                        <tr class="coacheCoacheeMapTr0">
                                          ...
                                          <td>
                                            <form:select onchange="coachIdTempValidation('-',0)" class="form-control" path="coachCoacheeMappingList[0].coachIdTemp" id="coachIdTemp0">
                                              <form:option value="-1"> Select Mentor/Coach </form:option>
                                              <c:forEach items="${coachList }" var="coach" varStatus="coachIndex">
                                          ...
                                          <td>
                                            <form:select onchange="coacheeIdTempValidation('-',0)" class="form-control" path="coachCoacheeMappingList[0].coacheeIdTemp" id="coacheeIdTemp0">
                                              <form:option value="-1"> Select Mentee/Coachee</form:option>
                                              <c:forEach items="${coacheeList }" var="coachee" varStatus="coacheeIndex">
                                          ...
                                          <td>
                                            <form:select onchange="actCoacheeProgramValidation('-',0)" class="form-control" path="coachCoacheeMappingList[0].actCoacheeProgram" id="actCoacheeProgram0">
                                              <form:option value="-1">Select EMC Program</form:option>
                                              <form:option value="1">Senior Executive Coaching</form:option>
                                              <form:option value="2">Top Executive Mentoring</form:option>
                                            </form:select>
                                          ...
                                          <td>
                                            <form:select onchange="supervisorIdTempValidation('-',0)" class="form-control" path="coachCoacheeMappingList[0].supervisorIdTemp" id="supervisorIdTemp0">
                                              <form:option value="-1">Select Supervisor </form:option>
                                              <c:forEach items="${supervisorList }" var="supervisor" varStatus="supervisorIndex">
                              ...
                              <div class="card-footer">
                                <button title="Add Stakeholder" style="float: right;" type="button" id="addMoreCoachCoachee" class="btn bg-3"><i
                                  class="fas fa-plus"></i>&nbsp;Add Stakeholders
                                </button>
                              </div>
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="card card-secondary">
                              <div class="card-header bg-2">
                                <h5 class="card-title font-weight-bold">Add Questions which will be raised to Mentor/Coach about the Mentee/Coachee</h5>
                              </div>
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-12 table-responsive tableDiv">
                                    <table class="table table-striped anand-table-font-size" id="questionTable">
                                      <thead class="bg-table-head">
                                        <tr>
                                          <th>Action</th>
                                          <th>Question</th>
                                    ...
                                    <input type="hidden" id="questionsField" name="questionsField">
                                  </div>
                                </div>
                              </div>
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addQuestionRow()" class="btn bg-2">
                          ...
                          <div class="col-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-1">
                                <h5 class="card-title font-weight-bold">Add Coach Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                              ...
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addfeedbackQuestionRow()" class="btn sequence-bg-1">
                                  <i class="fas fa-plus"></i>&nbsp;Add Coach Feedback Question
                                </button>
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-2">
                                <h5 class="card-title font-weight-bold">Add Coachee Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                                    ...
                                    <tbody id="feedbackCoacheeQuestionTableBody">
                                    </tbody>
                                  </table>
                                </div>
                              </div>
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addfeedbackCoacheeQuestionRow()" class="btn sequence-bg-2">
                                  <i class="fas fa-plus"></i>&nbsp;Add Coachee Feedback Question
                                </button>
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-4">
                                <h5 class="card-title font-weight-bold">Add Mentor Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                              ...
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addfeedbackMentorQuestionRow()" class="btn sequence-bg-4">
                                  <i class="fas fa-plus"></i>&nbsp;Add Mentor Feedback Question
                                </button>
                              </div>
                            </div>
                          </div>
                          <div class="col-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-5">
                                <h5 class="card-title font-weight-bold">Add Mentee Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                              ...
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addfeedbackMenteeQuestionRow()" class="btn sequence-bg-5">
                                  <i class="fas fa-plus"></i>&nbsp;Add Mentee Feedback Question
                                </button>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="card-footer">
                        <button title="Submit Coaching Batch" style="float: right;" title="Add Batch" type="submit" id="submitBatchButton" class="btn bg-1">Submit</button>
                      </div>
                    </div>
                  </form:form>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card card-secondary card-outline bg-card-primary-anand">
                    <div class="card-header bg-3">
                      <h5 class="card-title font-weight-bold">List of all Mentoring Batches</h5>
                    </div>
                    <div class="card-body">
                      <div class="row">
                            ...
                            <tbody>
                              <c:forEach items="${batchList }" var="batch" varStatus="batchLoop">
                                <tr class="bg-table-row-${batchLoop.index %2 }">
                                  ...
                                  <td>
                                    <c:choose>
                                      <c:when test="${batch.batchActive == 1}"><span class="badge sequence-bg-5">Active</span></c:when>
                                      <c:otherwise><span class="badge sequence-bg-1">Inactive</span></c:otherwise>
                                    </c:choose>
                                  </td>
              ...
              <div class="row editCoachingBatch">
                <div class="col-md-12">
                  <form:form modelAttribute="actCoachingBatch" action="emc-coaching-batch" id="actCoachingBatchEdit" method="post">
                    ...
                    <div class="card card-secondary">
                      <div class="card-header bg-3" data-card-widget="collapse">
                        <h5 class="card-title font-weight-bold">Edit Mentoring Batch</h5>
                        <div class="card-tools">
                      ...
                      <div class="card-body" style="display: block;">
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="daysBetweenTwoSession"><span class="mandatory">*</span>Avg days between two sessions(Senior Executive)</label>
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label for="daysBetweenTwoSessionTopExe"><span class="mandatory">*</span>Avg days between two sessions(Top Executive)</label>
                              <form:input type="text" class="form-control" id="daysBetweenTwoSessionTopExeEdit" placeholder="Enter Avg Days" path="daysBetweenTwoSessionTopExe" />
                              <span class="error invalid-feedback" id="daysBetweenTwoSessionError"></span>
                            </div>
                          </div>
                          <div class="col-md-2">
                          ...
                          <div class="col-md-12">
                            <div class="card card-secondary">
                              <div class="card-header bg-3">
                                <h5 class="card-title font-weight-bold">Edit Stakeholders</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                              ...
                              <div class="card-footer">
                                <button title="Add Mentor-Mentee-Supervisor" style="float: right;" type="button" id="editMoreCoachCoachee" class="btn bg-3">
                              <i class="fas fa-plus"></i>&nbsp;Add Stakeholders
                            </button>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="card card-secondary">
                              <div class="card-header bg-2">
                                <h5 class="card-title font-weight-bold">Edit Questions which will be raised to Mentor/Coach about the Mentee/Coachee</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-bordered anand-table-font-size" id="questionTableEdit">
                                    <thead class="bg-table-head">
                                      <tr>
                                        <th>Action</th>
                                        <th>Question</th>
                                    ...
                                    <tbody>
                                      <c:forEach var="question" items="${actCoachingBatch.questionTexts}" varStatus="status">
                                        <tr id="questionRow-${status.index}">
                                          <td>
                                            <button type="button" class="btn btn-danger btn-sm" onclick="removeQuestionRows('${status.index}', '${fn:escapeXml(question)}')">
                                              <i class="fas fa-trash"></i>
                                            </button>
                                          </td>
                                          <td>
                                            <input type="text" name="questionTexts[${status.index}]" value="${question}" class="form-control mb-2" />
                                          </td>
                                        </tr>
                                      </c:forEach>
                                    </tbody>
                              ...
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addQuestionRows()" class="btn bg-2">
                                  <i class="fas fa-plus"></i>&nbsp;Add Question
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-1">
                                <h5 class="card-title font-weight-bold">Edit Coach Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                              ...
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addEditfeedbackQuestionRow()" class="btn sequence-bg-1">
                                  <i class="fas fa-plus"></i>&nbsp;Add Coach Feedback Question
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-2">
                                <h5 class="card-title font-weight-bold">Edit Coachee Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                                    ...
                                    <tbody id="editfeedbackCoacheeQuestionTableBody">
                                    </tbody>
                                  </table>
                                </div>
                              </div>
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addEditfeedbackCoacheeQuestionRow()" class="btn sequence-bg-2">
                                  <i class="fas fa-plus"></i>&nbsp;Add Coachee Feedback Question
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-4">
                                <h5 class="card-title font-weight-bold">Edit Mentor Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                                    ...
                                    <tbody id="editfeedbackMentorQuestionTableBody">
                                    </tbody>
                                  </table>
                                </div>
                              </div>
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addEditfeedbackMentorQuestionRow()" class="btn sequence-bg-4">
                                  <i class="fas fa-plus"></i>&nbsp;Add Mentor Feedback Question
                                </button>
                              </div>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="card card-secondary">
                              <div class="card-header sequence-bg-5">
                                <h5 class="card-title font-weight-bold">Edit Mentee Feedback Questions</h5>
                              </div>
                              <div class="card-body">
                                <div class="col-12 table-responsive tableDiv">
                                  <table class="table table-striped anand-table-font-size" id="questionTable">
                                    ...
                                    <tbody id="editfeedbackMenteeQuestionTableBody">
                                    </tbody>
                                  </table>
                                </div>
                              </div>
                              <div class="card-footer">
                                <button title="Add Question" style="float: right;" type="button" onclick="addEditfeedbackMenteeQuestionRow()" class="btn sequence-bg-5">
                                  <i class="fas fa-plus"></i>&nbsp;Add Mentee Feedback Question
                                </button>
                              </div>
                            </div>
                      ...
                      <div class="card-footer">
                        <button type="submit" id="saveBatchChanges" style="float: right;"
                          class="btn bg-1" title="Save Batch Changes">Save Batch Changes</button>
                      </div>
                    </div>
                  </form:form>
                </div>
...
<div class="modal fade" id="batchInfoModal">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label>Batch Active/In-Active</label>
                ...
                <div class="row mt-4">
                    <div class="col-12 table-responsive tableDiv">
                        <table class="table table-striped anand-table-font-size" id="coachQuestionTable">
                            <thead class="bg-table-head">
                                <tr>
                                    <th>Coach Question</th>
                                </tr>
                            </thead>
                            <tbody id="info_feedbackQuestionTableBody"></tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 table-responsive tableDiv">
                        <table class="table table-striped anand-table-font-size" id="coacheeQuestionTable">
                            <thead class="bg-table-head">
                                <tr>
                                    <th>Coachee Question</th>
                                </tr>
                            </thead>
                            <tbody id="info_feedbackCoacheeQuestionTableBody"></tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 table-responsive tableDiv">
                        <table class="table table-striped anand-table-font-size" id="mentorQuestionTable">
                            <thead class="bg-table-head">
                                <tr>
                                    <th>Mentor Question</th>
                                </tr>
                            </thead>
                            <tbody id="info_feedbackMentorQuestionTableBody"></tbody>
                        </table>
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 table-responsive tableDiv">
                        <table class="table table-striped anand-table-font-size" id="menteeQuestionTable">
                            <thead class="bg-table-head">
                                <tr>
                                    <th>Mentee Question</th>
                                </tr>
                            </thead>
                            <tbody id="info_feedbackMenteeQuestionTableBody"></tbody>
                        </table>
                    </div>
                </div>
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn bg-3" data-dismiss="modal">Close</button>
            </div>
    ...
    <script src="usedStaticFiles/essentials/js/jsp_js_files/emc/coachingBatch/coachingBatch.js"></script>
    <script>
