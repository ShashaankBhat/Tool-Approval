	...
	<nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <!-- <img src="usedStaticFiles/essentials/images/logo.png" style="height:35px;padding-top:10px" alt="Company Logo" class="brand-image"> -->
        ...
        <li class="nav-item">
          ...
          <!-- <a title = "Filter" class="nav-link bg-3" data-widget="control-sidebar" data-slide="true" href="#" role="button">
