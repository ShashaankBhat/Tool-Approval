...
<html lang="en">
  <head>
    <title>BUSINESS UNIT | TOOL APPROVAL<%@include file="../../includeJSP/company_name_title.jsp"%></title>
    <%@include file="../../includeJSP/cssFiles.jsp"%>
  </head>
  <body class="sidebar-mini layout-fixed sidebar-collapse pace-primary">
    <div class="wrapper">
		          ...
		          <div class="card-body">
		            <div class="row">
		              <div class="col-md-12 tableOverFlowDiv">
		                <table class="table table-bordered table-striped dataTable nowrap" id="taBusinessUnitTable" style="width:100%">
		                  <thead>
    ...
    <script src="usedStaticFiles/essentials/js/jsp_js_files/ta/master/business-unit.js"></script>
  </body>
</html>