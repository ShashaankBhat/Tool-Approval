...
<html lang="en">
  <head>
    <title>STATUS | TOOL APPROVAL<%@include file="../../includeJSP/company_name_title.jsp"%></title>
  ...
  <body class="sidebar-mini layout-navbar-fixed sidebar-collapse pace-primary">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active"><strong>Status</strong></li>
                </ol>
              </div>
            </div>
          </div>
		              ...
		              <div class="row">
		                ...
		                <div class="col-md-3">
		                  <div class="form-check" id="isActiveDiv">
		                    <label class="font-3"><span class="mandatory">*</span>Status Active/InActive</label>
		                    ...
		                    <span class="invalid-feedback d-block" id="isActiveError"></span>
		                  </div>
		                </div>
		                <div class="col-md-1">
		                  <button type="submit" id="addStatus" class="btn bg-1">Submit</button>
		                </div>
		              </div>
		            </div>
		          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="taStatusNameEdit" class="font-1"><span class="mandatory">*</span>Status Name</label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="taStatusDescriptionEdit" class="font-2"><span class="mandatory">*</span>Description</label>
              ...
              <div class="col-md-6">
                <div class="form-check" id="isActiveEditDiv">
                  ...
                  <div class="custom-control custom-radio">
                    ...
                    <label for="taStatusActiveEdit1" class="custom-control-label sequence-font-5">Active</label>
                  </div>
                  <div class="custom-control custom-radio">
                    <input type="radio" name="taStatusActive" class="custom-control-input" id="taStatusActiveEdit2" value="0">
                    <label for="taStatusActiveEdit2" class="custom-control-label sequence-font-1">Inactive</label>
                  </div>
                  <span class="invalid-feedback d-block" id="isActiveEditError"></span>
                </div>
              </div>
          ...
          <div class="modal-footer justify-content-between">
            ...
            <button type="submit" id="editStatus" class="btn bg-1">Edit Status</button>
          </div>
          </form>
        </div>
      </div>
    ...
    <script src="usedStaticFiles/essentials/js/jsp_js_files/ta/master/status.js"></script>
  </body>
</html>
