...
<html lang="en">
  <head>
    <title>STATUS HISTORY | TOOL APPROVAL<%@include file="../../includeJSP/company_name_title.jsp"%></title>
  ...
  <body class="sidebar-mini layout-navbar-fixed sidebar-collapse pace-primary">
    ...
    <script src="usedStaticFiles/essentials/js/jsp_js_files/ta/master/status-history.js"></script>
  </body>
</html>
