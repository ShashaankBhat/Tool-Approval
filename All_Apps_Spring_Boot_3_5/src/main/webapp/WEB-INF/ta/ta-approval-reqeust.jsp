      ...
      <div class="content-wrapper">
        ...
        <section class="content content-margin">
          <div class="container-fluid">
            <div class="row">
              <div class="col-12">
                <form method="post" action="ta-approval-reqeust" modelAttribute="taToolRequest" id="ta-approval-reqeust">
                    ...
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                      <div class="tab-pane fade show active" id="tool-approval-details" role="tabpanel" aria-labelledby="tool-approval-details-tab">
                        ...
                        <div class="row">
                          ...
                          <div class="col-3 mt-2">
                            <button type="button" onclick="goToCostDetails();" id="saveTaApprovalMatrixChanges" class="btn sequence-bg-2" style="float:right" title="Go to Cost Details">
                      ...
                      <div class="tab-pane fade" id="cost-details" role="tabpanel" aria-labelledby="cost-details-tab">
                            ...
                            <table class="table-bordered table-striped" id="approvalMatrixTable" style="width:100%">
                              ...
                              <tbody>
                                ...
                                <tr style="text-align:center" id="costDetailRow${toolCostDetailsIndex }">
                                  ...
                                  <td>
                                    <input style='width:140px' type="text" name="tempToolRequestCostDetail[${toolCostDetailsIndex}].toolPartNumber" value="${costDetail.toolPartNumber }" id="toolPartNumber${toolCostDetailsIndex}" class="input-group-sm"/>
                                  </td>
                                  <td>
                                    <input style='width:150px' type="text" name="tempToolRequestCostDetail[${toolCostDetailsIndex}].partDescription" value="${costDetail.partDescription }" id="partDescription${toolCostDetailsIndex}" class="input-group-sm"/>
                                  </td>
                                  <td>
                                  ...
                                  <td>
                                    <input style='width:70px' type="number" step="0.0001" min="0" name="tempToolRequestCostDetail[${toolCostDetailsIndex}].quotedCost" value="${costDetail.quotedCost }" id="quotedCost${toolCostDetailsIndex}" class="input-group-sm" required/>
                                  </td>
                                  <td>
                                    <input style='width:70px' type="number" step="0.0001" min="0" name="tempToolRequestCostDetail[${toolCostDetailsIndex}].negotiatedCost" value="${costDetail.negotiatedCost }" id="negotiatedCost${toolCostDetailsIndex}" class="input-group-sm" required/>
                                  </td>
                                  <td>
                                    <input style='width:70px' type="number" step="0.0001" min="0" name="tempToolRequestCostDetail[${toolCostDetailsIndex}].upfrontCost" value="${costDetail.upfrontCost }" id="upfrontCost${toolCostDetailsIndex}" class="input-group-sm"/>
                                  </td>
                                  <td>
                                    <input style='width:80px' type="number" step="0.0001" min="0" name="tempToolRequestCostDetail[${toolCostDetailsIndex}].amortizationCost" value="${costDetail.amortizationCost }" id="amortizationCost${toolCostDetailsIndex}" class="input-group-sm"/>
                                  </td>
                                  <td>
                                    <textarea id="supplierName${toolCostDetailsIndex}" rows="2" style='width:145px' name="tempToolRequestCostDetail[${toolCostDetailsIndex}].supplierName" id="supplierName${toolCostDetailsIndex}" class="input-group-sm">${costDetail.supplierName }</textarea>
                                  </td>
                                  <td>
                                    <input style='width:100px' type="text" name="tempToolRequestCostDetail[${toolCostDetailsIndex}].developmentLeadTime" value="${costDetail.developmentLeadTime }" id="developmentLeadTime${toolCostDetailsIndex}" class="input-group-sm" />
                                  </td>
                                  <td>
                                    <textarea  id="costRemarks${toolCostDetailsIndex}" rows="2" style='width:145px' name="tempToolRequestCostDetail[${toolCostDetailsIndex}].remarks" class="input-group-sm" id="remarks${toolCostDetailsIndex}">${costDetail.remarks }</textarea>
                                  </td>
                                </tr>
                                <c:set var="toolCostDetailsIndex" value="${toolCostDetailsIndex + 1 }" />
                                </c:forEach>
                        ...
                        <div class="row">
                          <div class="col-9"></div>
                          <div class="col-3 mt-2">
                            <button type="button" id="addMorePartCost" onclick="addMoreToolCostDetail()" class="btn bg-3" style="float:right" title="Add More Part Cost Details">
                          ...
                          <div class="col-6">
                            <div class="form-group">
                              ...
                              <textarea id="toolingPaymentRemark" name="costDetailsList[0].toolingPaymentRemark" class="form-control" rows="2">
                                ${not empty costDetailsList ? costDetailsList[0].toolingPaymentRemark : ''}
                              </textarea>
                            </div>
                          </div>
                          <div class="col-6"></div>
                          <div class="col-3 mt-2">
                            <button type="button" onclick="goToToolApprovalDetails();" id="saveTaApprovalMatrixChanges" class="btn bg-2" style="float:left" title="Go back to Tool Approval Details">
                              <i class="fas fa-step-backward"></i>&ensp;Back
                            </button>
                          </div>
                          <div class="col-6"></div>
                          <div class="col-3 mt-2">
                            <button type="button" id="saveTaApprovalMatrixChanges" class="btn sequence-bg-4" title="Save Tool Details in Draft">
                              <i class="fas fa-tasks"></i>&ensp;Save as Draft
                            </button>
                            <button type="submit" id="saveTaApprovalMatrixChanges" class="btn sequence-bg-5" style="float:right" title="Submit Tool Details for Approval">
                ...
                <input type="number" value="${toolCostDetailsIndex }" type="hidden" id="toolCostDetailsIndex" />
              </div>
            </div>
          </div>
        </section>
