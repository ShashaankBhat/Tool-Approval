...
function openDownloadModal(batchId, coacheeId) {
    ...
    const url = `get-documents?batchId=${encodeURIComponent(batchId)}&coacheeId=${encodeURIComponent(coacheeId)}`;
          ...
          if (!files || files.length === 0) {
              ...
              files.forEach(file => {
                  ...
                  li.innerHTML = `
                    ...
                    <a class="btn btn-sm btn-outline-primary" href="${file.url}" download>
