	...
	$.ajax({
		...
		success: function(result) {
			...
			/*if(result["batchActive"] == "1") {
				$("#batchActiveInfo").html("<span class='badge sequence-bg-1'>Active</span>");
			} else if(result["batchActive"] == "2") {
				$("#batchActiveInfo").html("<span class='badge sequence-bg-3'>Closed</span>");
			} else {
				$("#batchActiveInfo").html("<span class='badge sequence-bg-5'>In-Active</span>");
			}*/
			if(result["batchActive"] == "1") {
